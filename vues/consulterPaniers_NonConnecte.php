...
<head>
<meta charset="utf-8"/>
<title> Consulter les paniers (non connecté) </title>
      ...
      $resultProuits = mysqli_query($co, $reqProduits) or die(mysqli_error($co)) ;
          ...
          echo "<div class='col-lg-3'>" ;
            echo "<div class='position-relative m-5'>" ;
              ...
              echo "<p><a href='detailsDuPanier_NonConnecte.php?numPanier=".$panier['numPanier']."'><button class='btn btn-outline-primary'>Détails</button></a></p>" ;
              echo "</div>" ;
        }
      }
    ?>
