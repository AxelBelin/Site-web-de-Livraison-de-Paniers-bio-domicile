...
?>		
      ...
      ?>
        ...
        <form method='post' action='../controleurs/commanderPanier.php'>
        <label for='test'class='form-label'> quantité :</label>
          <input type='number' name='qte' min='1' max="200">
          <input id='prodId' name='prodId' type='hidden' value="<?php echo $numPanier ?>">
        <p></p>
        <input type='submit' name='valid' class='btn btn-outline-primary' value='Commander'> </form></p>
				<div class="text-center">
                <p>
                    <a href="consulterPaniers_Client.php"><button class="btn btn-primary">Retour</button></a>
                </p>
                </div>
